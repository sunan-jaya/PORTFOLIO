const ContactLink = [
    ...
    icon: <svg width="25" height="25" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.linkedin.com/in/sunan-jaya-irmawan',
    ...
    {
      href: 'https://www.github.com/sunan-jaya',
      icon: <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/sunanjy',
      icon: <svg width="25" height="25" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const Contact_Layout = () => {
  return (
    <section id="contact" className="section pb-10 bg-zinc-900">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">

            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col max-sm:mb-7">
                <h2 className="headline-2 lg:max-w-[12ch]">
                Contacts
                </h2>

                <p className="text-zinc-400 mt-3 mb-3 max-w-[50ch] lg:max-w-[30ch] ">
                Let's work together! Start from Now!
                </p>

                <div className="flex items-center gap-2 ">
                    {ContactLink.map(({href, icon}, key) => (
            ...
            <form action="https://getform.io/f/akkkldra" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        <div className="">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Sunan Jaya" className="text-field" />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        <div className="">
                            ...
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="sunan@yourmail.com" className="text-field" />
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder="Write your message..." required className="text-field resize-y min-h-32 max-h-80"></textarea>
                </div>
