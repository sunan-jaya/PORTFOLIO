...
const Navbar_Layout = ({ onLanguageChange }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 w-full h-20 max-sm:h-[70px] flex items-center z-40 bg-gradient-to-b from-zinc-800 to-zinc-900/0 `}>
        <div className="max-w-screen-2xl w-full mx-auto lg:px-24 px-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-5">  
              ...
              <div className="flex items-center">
                  ...
                  >
                    <div className={`group toggle-icon max-w-max h-10 font-extrabold text-xl rounded-lg max-sm:text-xl`}>
                        {language === 'en' ? (
                            // BUTTON [ENGLISH]
                            <>
              ...
              <a 
                href="#contact" 
                className="btn btn-secondary max-sm:hidden "
              >
                Contact Me
              </a>
