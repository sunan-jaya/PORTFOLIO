...
const Portfolio_Card_Square = ({ imgSrc, title, tags, projectLink, category, description }) => {
  return (
    // DESIGN PROJECT CARD
    <motion.div
      className="group relative overflow-hidden rounded-2xl bg-zinc-800/50 border border-zinc-700/30 hover:border-orange-500/50 transition-all duration-300 shadow-xl hover:shadow-2xl"
...
Portfolio_Card_Square.propTypes = {
...
export default Portfolio_Card_Square;