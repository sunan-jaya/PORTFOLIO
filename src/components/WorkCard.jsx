  ...
  return (
    <div className={"relative p-4 rounded-xl bg-zinc-800 hover:bg-zinc-700/50 active:bg-zinc-700/60 ring-1  ring-inset ring-zinc-50/5 transition-colors" + classes}>
        ...
        <div className="flex items-center justify-between gap-5">
            ...
            <div className="w-11 h-11 rounded-lg grid place-items-center bg-orange-400 text-zinc-950 shrink-0">
                <span className="material-symbols-rounded" aria-hidden="true">arrow_outward</span>
            </div> 
        </div>

        <Link to={projectLink} className="absolute inset-0" target='_blank'></Link>
    </div>
  )
}
