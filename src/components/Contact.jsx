        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <form action="https://getform.io/f/akkkldra" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        <div className="">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Sunan Jaya" className="text-field reveal-up" />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        <div className="">
                            ...
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="sunan@yourmail.com" className="text-field reveal-up" />
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder="Write your message..." required className="text-field resize-y min-h-32 max-h-80 reveal-up"></textarea>
                </div>
